...
class Biblioteca:
    ...
    def __init__(self):
        self.libros = {}  # {1: Libro(1, "Albe Camp", "¿Cómo escribir?"), 2: Libro(2, "Felpo Berto", "Recetas de la abuela")}
...
if __name__ == '__main__':
    ...
    libro1 = Libro(1, "Albe Camp", "¿Cómo escribir?") 
    libro2 = Libro(2, "Felpo Berto", "Recetas de la abuela")
